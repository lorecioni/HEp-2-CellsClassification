...
for v = 0 : Gabor_options.num_scale-1
    for u = 0 : Gabor_options.num_theta-1
        [ GaborReal(:,:,tmpCNTR), GaborImg(:,:,tmpCNTR) ] = MakeGaborKernal( Gabor_options, u, v);
...
function [GaborReal, GaborImg] = MakeGaborKernal(Gabor_options, U, V)
% function [GaborReal, GaborImg] = MakeGaborKernal[GaborW, U, V]
%            ||Ku,v||^2
